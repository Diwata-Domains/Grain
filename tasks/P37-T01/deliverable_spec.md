# Deliverable Spec: P37-T01 — Engine envelope + typed-error foundation
...
### New Files
- `tasks/P37-T01/task.md` — packet metadata/scope ✓
- `tasks/P37-T01/deliverable_spec.md` — this file ✓
...
> `get_version()` lives in `src/grain/version.py` (P37-T02). If T02 has not landed when
...
- `src/grain/version.py` / `get_version()` extraction (P37-T02).
- `domain/capabilities.py` / capability registry (P37-T03).
