# Deliverable Spec: P37-T03 — Capability registry (code source of truth)

## Required Output

### New Files
- `tasks/P37-T03/task.md` — packet metadata/scope ✓
- `tasks/P37-T03/deliverable_spec.md` — this file ✓
