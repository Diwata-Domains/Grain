# Deliverable Spec: P37-T09 — Non-interactive completeness

## Required Output

### New Files
- `tasks/P37-T09/task.md` — packet metadata/scope ✓
- `tasks/P37-T09/deliverable_spec.md` — this file ✓
...
- The json + not-assume_yes branch builds
  ...
  gate=spec.to_dict(), command=<cmd>)` and prints it through the P37-T04 emit seam (same
