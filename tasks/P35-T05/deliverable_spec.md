# Deliverable Spec: P35-T05 — engine_error_to_forge extraction

## Required Output

### New Files
- `tasks/P35-T05/task.md` — packet metadata/scope ✓
- `tasks/P35-T05/deliverable_spec.md` — this file ✓
...
| `isinstance(exc, ...)` (most-specific first) | returns | `.code` (P35-T01) | `.exit_code` | message, detail |
|---|---|---|---|---|
...
The `.code` / `.exit_code` are NOT set here — they are the ClassVars P35-T01 puts on each
