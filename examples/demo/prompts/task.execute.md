...
If the conversation has drifted and you are no longer sure the packet, workflow state, or verification state on disk matches the chat, stop and return to `grain --format json workflow next` before continuing.
