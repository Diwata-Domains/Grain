...
def build_task_level_plan(
    ...
    *,
    ...
    if not active:
        ...
        return CommandResult(ok=True, command="orchestration task-plan", repo=str(root)), plan
...
def analyze_scope_signals(
    ...
    *,
    ...
    return (
        CommandResult(ok=True, command="orchestration scope-signals", repo=str(root)),
        payload,
    )
...
def build_phase_level_plan(
    ...
    *,
    ...
    return CommandResult(ok=True, command="orchestration phase-plan", repo=str(root)), plan
