...
1. `phase.plan.next.md`
2. `phase.tasks.seed.md`
3. `task.plan.next.md` only when needed
4. `task.execute.md`
5. `task.review.md`
6. `task.close.md`
...
1. `task.plan.next.md` only when needed
2. `task.execute.md`
3. `task.review.md`
4. `task.close.md`
...
1. `project.health.md`
2. `phase.review.md` or `phase.review_and_close.md`
